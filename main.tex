...
%\coorientador{}
\local{Lavras -- MG}
\bancaum{Prof. Dr. ***}{UFLA}
\bancadois{Prof. Dr. ***}{UFLA} 
\bancatres{Prof. Dr. ***}{UFLA}
\bancaquatro{Prof. Dr. ***}{UFLA}
\defesa{*** de *** de ***}
%==============================================================================
%##################################################
...
\dedic{
   Ao Arquiteto de todo o Universo, o mais perfeito e complexo equilíbrio entre ordem e caos, o qual as mentes se esforçam para compreender. Aos meus pais, Jailson e Tânia, alicerces da minha jornada, que tornaram possível a realização deste objetivo. Aos meus amigos e à minha namorada, pela presença e apoio em todos os momentos.
}

\thanks{
   Agradeço primeiramente a Deus, pela vida, pela força e pela luz que tornaram possível a superação dos muitos obstáculos ao longo desta jornada acadêmica.
   
   Aos meus pais, Jailson e Tânia, e ao meu irmão, Gabriel, pelo amor, pelos sacrifícios e pelo incentivo constante. Vocês são a minha base e este diploma é também de vocês. Obrigado pela compreensão (às vezes nem tanto) nos momentos de ausência e pelo apoio inabalável.

   À minha namorada, Priscilla, pelo acompanhamento constante, pelo incentivo inabalável e pela paciência demonstrada ao longo de toda esta jornada. Agradeço por nunca me deixar esquecer das obrigações com este trabalho, mesmo nos momentos de desânimo, e por estar sempre ao meu lado, oferecendo suporte emocional e compreensão. Seu apoio foi fundamental para que eu pudesse manter o foco e a determinação necessários para a conclusão desta etapa importante.

   Ao meu orientador, Prof. Dr. Moises Porfírio Rojas Leyva, pela oportunidade de trabalhar com um tema tão fascinante quanto a Computação Quântica. Agradeço pela paciência, pelas correções minuciosas, pela orientação segura e, acima de tudo, pelo exemplo de rigor científico e profissionalismo.

   À Universidade Federal de Lavras (UFLA) e ao Departamento de Física, pela infraestrutura de excelência e pelo corpo docente qualificado, tanto em nível técnico quanto pessoal, que contribuiu para a minha formação. Agradeço a todos os professores que, direta ou indiretamente, participaram do meu crescimento intelectual.

   Agradeço também à IBM Quantum, por disponibilizar o acesso aos processadores quânticos através da nuvem, sem os quais a parte experimental deste trabalho e a análise em hardware real não teriam sido possíveis.

   Aos meus amigos de curso, Duanny, Raissa e Gabriely, pelo companheirismo, pelas horas de estudo em conjunto, pelas caronas e pelos muitos momentos de descontração -- as várias horas de vôlei, as pedaladas, as idas ao CIUNI, os almoços e jantares, as conversas, enfim, por terem estado comigo e me permitirem estar com vocês, o que tornou a caminhada mais leve.
...
\include{Chapters/ferramentas}
\include{Chapters/procedimento}
